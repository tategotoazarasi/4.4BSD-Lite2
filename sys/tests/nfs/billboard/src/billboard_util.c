 ...
 */
void
        bb_call_set_unset(flag, bb_set_in_p) int flag;
 ...
 */
void
        bb_set_unset_print_result(flag, bb_set_in_p, bb_set_out_p) int flag;
BB_set_in *bb_set_in_p;
BB_set_out *bb_set_out_p;
{
 ...
 */
void
        bb_list(flag, bb_list_in_p) int flag;
 ...
 */
void
        bb_list_print_result(flag, bb_list_in_p, bb_list_out_p) int flag;
BB_list_in *bb_list_in_p;
BB_list_out *bb_list_out_p;
{
	int i;
                ...
                BB_passwd_in *bb_passwd_in_p;
{
	 ...
	 * issue the RPC call
	 */
	if((status_p = (int *) bb_call_rpc(bb_passwd_set_1, bb_passwd_in_p)) != NULL) {
		printf("\n");
		switch(*status_p) {
			case BB_SUCCESS:
